...
function Event(doing){
  this.author = doing.author;
  this.categories = doing.category;
  this.summary = doing.description;
  this.img_url = doing.image;
  this.date = doing.published;
  this.title = doing.title;
}
